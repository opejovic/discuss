      ...
      >
        ...
        >
          <ul
            ...
            ref="channels"
            class="mt-2 mb-2 w-full search-select-options"
          >
            <li
            ...
            >
              <a
                ...
                class="hover:bg-gray-300 p-4 -ml-4 cursor-pointer"
              >
                {{ notification.data.message }}
                {{ formattedTime(notification.data.reply) }}
              </a>
              <div
                id="delete"
...
export default {
  ...
  methods: {
    ...
    formattedTime(reply) {
      return moment(reply.created_at)
        .startOf("hour")
        .fromNow();
    },
